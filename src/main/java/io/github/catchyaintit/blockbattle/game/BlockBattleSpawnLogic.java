...
import io.github.catchyaintit.blockbattle.BlockBattle;
...
public class BlockBattleSpawnLogic {
    private final GameSpace gameSpace;
    private final BlockBattleMap map;

    public BlockBattleSpawnLogic(GameSpace gameSpace, BlockBattleMap map) {
    ...
    public void spawnPlayer(ServerPlayerEntity player) {
        ...
        if (pos == null) {
            BlockBattle.LOGGER.error("Cannot spawn player! No spawn is defined in the map!");
            return;
        }
